...
const SIGNS = [
  ...
  { id: 's10', category: 'forbud', shape: 'circle', color: '#e74c3c', symbol: '30',  name: 'Fartsgrense',            number: '362', description: 'Fartsgrense i km/t. Du kan IKKE kjøre raskere enn det angitte tall fra skiltet til neste endring.' },
  ...
  { id: 's15', category: 'påbud', shape: 'circle-blue', symbol: '↗',  name: 'Sving til høyre',    number: '402', description: 'Du MÅ svinge til høyre. Påbudsskilt – ingen valgfrihet.' },
  ...
  { id: 's32', category: 'prioritet', shape: 'rect-blue',                        name: 'Motorveg',             number: '502', description: 'Motorveg starter. Særregler gjelder: minstehastighet, forbikjøring kun til venstre, ingen stopp.' },
  { id: 's33', category: 'prioritet', shape: 'rect-gray',                        name: 'Slutt motorveg',       number: '503', description: 'Motorvegen slutter. Vanlige trafikkregler gjelder igjen.' },
];
