...
const QUESTIONS = [
  ...
  {     scenario: '🚗 Du kjører 70 km/t i en 60-sone og passerer en fartskontroll.',
    ...
    correct: 0,
    explanation: 'Fartsoverskridelse under 16 km/t = 0 prikker (kun bot). 16-20 km/t = 2 prikker. 21-25 km/t = 3 prikker. Over 25 km/t = flere prikker og mulig beslag av førerkort. 8 prikker i 3 år = tap av førerrett. (Ref: Forskrift om prikkbelastning 2016)' },
...
const SIGNS = [
  ...
  { id: 's13', category: 'forbud', shape: 'circle', color: '#e74c3c', symbol: '||',  name: 'Stans forbudt',          number: '376.1', description: 'Absolutt stans og parkering forbudt. Ikke stopp her under NOEN omstendigheter.' },
