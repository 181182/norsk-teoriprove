...
const QUESTIONS = [
  ...
  },
  {
    ...
    correct: 1,
    explanation: 'Forbikjøring forbudt-skiltet (334) betyr at du IKKE kan kjøre forbi biler fra dette punkt. Forbudet gjelder til neste kryss, en hvit strek på vegbanen (opphevingsskilt 526), eller skiltet "Slutt forbikjøring forbudt". Brudd på dette er svært alvorlig.'
  },
  {
  ...
  },
  {
    ...
    correct: 1,
    explanation: 'Norges grense for alkohol i blodet er 0.2 promille (senket fra 0.5 i 2001). Ved 0.2-0.5 promille: stor bot og midlertidig tap av førerkortet. Ved 0.5-1.2 promille: bøter, betinget/ubetinget fengsel. Over 1.2 promille: ubetinget fengsel. Det er INGEN safe limit – kjør aldri etter å ha drukket.'
  },
  ...
  {     scenario: '🚛 Du planlegger å leie en tilhenger for flytting.',
  ...
  {     scenario: '🚛 Du kjører med ubremset tilhenger på motorvegen.',
    ...
    options: ['60 km/t', '70 km/t', '80 km/t', '90 km/t'],
    correct: 0,
    explanation: 'Med tilhenger UTEN bremser er maksfarten 60 km/t. Med tilhenger MED bremser: inntil fartsgrensen, men maks 80 km/t for tunge kombinasjoner. (Ref: Trafikkreglene § 5-2)' },
  {     scenario: '🚗 Du har glemt noe og vil rygge tilbake.',
    signs: ["s32"],
  ...
  { id: 149, category: 'trafikkregler', difficulty: 'lett',
    ...
    correct: 2,
    explanation: 'Enveiskjøringsskilt (skilt 526) betyr at all trafikk skal kjøre i den retningen pilen viser. Møtende trafikk er forbudt. (Ref: Skiltforskriften § 14)' },
  {     scenario: '🏫 Klokken er 23:00 på en søndag. Du kjører forbi en skole med 30-skilt.',
    signs: ["s10"],
  ...
  {     scenario: '💥 Du ser en ulykke langs vegen. Folk står rundt.',
    diagram: 'emergency_stop',
  ...
  {     scenario: '🛴 Du ser en el-sparkesykkel på fortauet.',
  ...
  {     scenario: '🚌 En gul skolebuss har stoppet med blinkende lys foran deg.',
  ...
  {     scenario: '🚧 Du kjører inn i en vegarbeidsone. En person med flagg viser stoppetegn.',
    signs: ["s22"],
  ...
  {     scenario: '🚋 Du nærmer deg et kryss der en sporvogn kommer fra venstre.',
  ...
  {     scenario: '❄️ Du kjører over fjellet i januar og ser et kjettingpåbud-skilt.',
  ...
  {     scenario: '🚒 En brannbil med blålys og sirene nærmer seg fra høyre i et kryss.',
  ...
  {     scenario: '📱 Du sitter i kø og vil sjekke en melding på telefonen.',
  ...
  {     scenario: '❄️ Du er bak en snøplog på en smal fjellveg.',
  ...
  {     scenario: '🚗 Du kjører ut fra garasjen og inn på hovedvegen.',
  ...
  {     scenario: '🆕 Du bestod førerprøven for 8 måneder siden.',
  ...
  {     scenario: '🚧 Du ser oransje skilt langs en vegstrekning.',
    signs: ["s22"],
  ...
  {     scenario: '🚗 Du kjører en vanlig personbil og ser et forbudsskilt med underskilt.',
  ...
  {     scenario: '🛣️ Du kjører inn på en veg med blått motorveg-lignende skilt.',
    signs: ["s32"],
    id: 169, category: 'skilt', difficulty: 'vanskelig',
    question: 'Hva er forskjellen mellom skilt 502 (motorveg) og 503 (motortrafikkveg)?',
    ...
    correct: 1,
    explanation: 'Motorveg (502) har strengere regler: minst to felt i hver retning, midtdeler, maks 110 km/t. Motortrafikkveg (503) kan ha ett felt, maks 90 km/t, men samme forbud mot gående og syklende. (Ref: Skiltforskriften § 23)' },
  {     scenario: '🚗 Du ser et skilt med teksten BLINDVEG.',
  ...
  {     scenario: '🚗 Du kjører en stor varebil og ser et hvitt skilt med "3.5t".',
  ...
  {     scenario: '🚐 Du kjører en campingbil og nærmer deg en tunnel.',
  ...
  {     scenario: '🏘️ Du kjører inn i et boligområde med 30-sone skilt.',
  ...
  {     scenario: '🚗 Du ser et rundt rødt skilt med kryss-streker.',
    signs: ["s13"],
    id: 174, category: 'skilt', difficulty: 'lett',
    question: 'Hva betyr skilt 370 (rund rød sirkel med to blå diagonale streker)?',
    options: ['Parkering forbudt', 'Stans forbudt', 'Innkjøring forbudt', 'Forbikjøring forbudt'],
    correct: 1,
    explanation: 'Skilt 370 (stans forbudt) har kryss-streker og betyr at ALL stans er forbudt, inkludert korte stopp for av/påstigning. Strengere enn parkering forbudt (372). (Ref: Skiltforskriften § 19)' },
  ...
  {     scenario: '🏘️ Du kjører inn i et gatetun og ser skiltet.',
    id: 176, category: 'skilt', difficulty: 'vanskelig',
    question: 'Du ser skiltet "Gatetun" (skilt 540). Hva gjelder?',
    options: ['Normal fartsgrense 50 km/t', 'Fartsdempende tiltak – hold gangfart', 'Kjøring forbudt – kun gående', 'Fartsgrense 30 km/t'],
    correct: 1,
    explanation: 'I gatetun (skilt 540) gjelder gangfart (ca. 5-7 km/t). Fotgjengere har forkjørsrett overalt. Parkering er kun tillatt på oppmerkede plasser. (Ref: Trafikkreglene § 7a)' },
  ...
  // --- VIKEPLIKT (expanded) ---
  {     scenario: '🚗 Tre biler møtes i et uskiltert kryss.',
    diagram: 'crossroads_four_way',
  ...
  {     scenario: '🚋 Du nærmer deg et kryss der en trikk kommer fra venstre.',
  ...
  {     scenario: '🔄 Du er i ytre felt i en stor rundkjøring.',
    diagram: 'roundabout_2lane',
  ...
  {     scenario: '🚲 Du skal svinge til høyre. En syklist er på din høyre side.',
    signs: ["s25"],
  ...
  {     scenario: '🅿️ Du kjører ut fra en parkeringsplass til en trafikkert veg.',
  ...
  {     scenario: '👮 Politiet dirigerer i et kryss. Lyset er grønt, men politiet viser stopp.',
  ...
  {     scenario: '🚗 Du er på forkjørsveg og skal svinge til venstre. Bil kommer mot deg.',
    diagram: 'crossroads_four_way',
    signs: ["s20"],
  ...
  {     scenario: '🚦 Du lurer på hva som gjelder mest: skilt, lys, politi eller høyreregelen?',
  ...
  {     scenario: '🚑 Ambulanse med blålys bakfra mens du er i rundkjøring.',
    diagram: 'roundabout',
  ...
  {     scenario: '🚶 En person står ved gangfeltkanten og ser ut som de vil krysse.',
    diagram: 'pedestrian_crossing_scenario',
  ...
  {     scenario: '🚗 Du kjører 100 km/t og lurer på hvor langt du kjører bare i reaksjonstiden.',
    diagram: 'stopping_distance',
  ...
  {     scenario: '🌧️ Kraftig regn på motorvegen. Fartsgrensen er 80 km/t.',
    diagram: 'aquaplaning',
  ...
  {     scenario: '⛽ Du lurer på den mest økonomiske hastigheten for langturer.',
  ...
  {     scenario: '🚗 Du kjører 70 km/t i en 60-sone og passerer en fartskontroll.',
    ...
    correct: 0,
    explanation: '10 km/t over i 60-sone = 0 prikker, kun forenklet forelegg (bot). NB: Prikksystemet varierer etter fartsgrense-sone. I 60-soner: under 16 km/t over = 0 prikker. I lavere soner (30-50 km/t): prikker kan komme fra 11 km/t over. 8 prikker i 3 år = tap av førerrett. (Ref: Forskrift om prikkbelastning)' },
  {     scenario: '🌧️ Det regner kraftig og sikten er dårlig. Fartsgrensen er 80 km/t.',
  ...
  {     scenario: '🚨 Du passerer et ulykkessted der ambulansepersonell jobber på vegen.',
    diagram: 'emergency_stop',
  ...
  // --- KJØRETØY (expanded) ---
  {     scenario: '🔧 Bilen din er 5 år gammel. Du har aldri tatt EU-kontroll.',
  ...
  {     scenario: '👶 Du skal kjøre med et barn på 3 år i bilen.',
  ...
  {     scenario: '❄️ Bilen begynner å slenge på glatt veg. ESP-lampen blinker.',
  ...
  {     scenario: '🚗 Du planlegger en 8-timers kjøretur gjennom Norge.',
  ...
  {     scenario: '🔧 Du sjekker dekkene og legger en mynt i mønsteret.',
  ...
  // --- MILJØ (expanded) ---
  {     scenario: '🚗 Du vil kjøre mer økonomisk og lurer på den beste teknikken.',
  ...
  {     scenario: '🚗 Du sitter i bilen med motoren i gang mens du venter på noen.',
  ...
  {     scenario: '🏙️ Du kjører en eldre dieselbil inn mot Oslo sentrum.',
  ...
  {     scenario: '⚡ Du vurderer å kjøpe elbil og lurer på fordelene.',
  ...
  {     scenario: '🔊 Du kjører med piggdekk i byen og lurer på støy.',
  ...
  {     scenario: '🚨 Du finner en bevisstløs person som puster normalt.',
  ...
  {     scenario: '🚨 Du starter HLR på en bevisstløs person uten pust.',
  ...
  {     scenario: '💥 Du ankommer en trafikkulykke som førstemann.',
    diagram: 'emergency_stop',
  ...
  {     scenario: '🚨 En motorsyklist har veltet. Du mistenker nakkeskade.',
  ...
  {     scenario: '🩸 En person har et dypt kutt i underarmen som blør kraftig.',
  ...
  {     scenario: '🚨 En person er blek, kaldsvett og har rask puls etter ulykke.',
  ...
  {     scenario: '🅿️ Du ser en gul kantlinje langs fortauskanten.',
    ...
    correct: 0,
    explanation: 'Gul enkelt kantlinje = stans forbudt. Gul dobbelt kantlinje = stans og parkering forbudt. Gul stiplet linje = parkering forbudt (men kortvarig stans tillatt). (Ref: Skiltforskriften)' },
  {     scenario: '♿ Du finner en ledig HC-parkering, men har ikke HC-bevis.',
  ...
  {     scenario: '🚌 Du vil parkere nær en bussholdeplass.',
  ...
  {     scenario: '🌫️ Tett tåke på vegen. Du lurer på å slå på bakre tåkelys.',
  ...
  {     scenario: '🌙 Du kjører med nærlys i mørket på en rett veg.',
  ...
  {     scenario: '🦌 Du ser to lysende øyne langs veikanten i skumringen.',
    signs: ["s7"],
  ...
  {     scenario: '🌙 En motkommende bil har fjernlys som blender deg.',
  ...
  {     scenario: '🛣️ Du ser gule skråstriper malt på vegbanen.',
  ...
  {     scenario: '🛣️ Du ser heltrukken linje på din side og stiplet på den andre.',
  ...
  {     scenario: '🛣️ Hvite piler i kjørefeltet peker til venstre.',
  ...
  {     scenario: '🛣️ Du nærmer deg en bred hvit linje tvers over vegen.',
  ...
  {     scenario: '🛣️ Du kjenner vibrasjoner i rattet fra striper i vegbanen.',
  ...
  {     scenario: '❄️ Det er 1°C og du kjører over en bro tidlig om morgenen.',
  ...
  {     scenario: '❄️ Du kjører en 4WD SUV på isete veg og føler deg trygg.',
    diagram: 'winter_braking',
  ...
  {     scenario: '❄️ Det er oktober og plutselig glatt på fjellovergangen.',
  ...
  {     scenario: '❄️ Bilen begynner å gli sideveis i en sving.',
    diagram: 'winter_braking',
  ...
  {     scenario: '🚇 Du nærmer deg en lang tunnel på motorvegen.',
  ...
  {     scenario: '🚧 Du kjører inn i en vegarbeidsone med oransje 50-skilt.',
    signs: ["s22"],
  ...
  {     scenario: '😴 Du har tunge øyelokk og gjesper gjentatte ganger bak rattet.',
  ...
  {     scenario: '🏔️ Smal fjellveg. En bil kommer oppover, du kjører nedover.',
  ...
  {     scenario: '🚗 ABS aktiveres under nødstopp – du kjenner vibrasjoner i pedalen.',
  ...
  {     scenario: '🚗 Du vil forbedre kjørestilen din for å unngå farlige situasjoner.',
  ...
  { id: 247, category: 'parkering', difficulty: 'vanskelig',
    ...
    options: ['Kl. 18:00 fredag', 'Kl. 17:00 fredag', 'Innen kl. 09:00 mandag (1 time gjenstår av reguleringstiden)', 'Kl. 08:00 mandag'],
    correct: 2,
    explanation: 'Reguleringstiden er 08-17 man-fre. Du parkerte kl. 16:00 fredag = 1 time brukt (16-17). I helgen teller ikke tid. Mandag 08:00 starter klokken igjen med 1 time gjenstående. Du må flytte innen 09:00 mandag.' },
  {     scenario: '🌅 Du kjører mot solen i skumringen – kontrasten er svært dårlig.',
  ...
  {     scenario: '🚗 To kjørefelt slås sammen til ett foran deg.',
    diagram: 'motorway_merge',
  ...
  {     scenario: '🔧 Du har hatt motorstopp langs motorvegen.',
    diagram: 'emergency_stop',
  ...
  {     scenario: '🚗 Du frakter en lang planke som stikker 1 meter ut bak bilen.',
  ...
  {     scenario: '🚑 Du hører sirener og ser blålys i speilet.',
  ...
  {     scenario: '🚗 Du kjører 95 km/t i 80-sone og passerer en fotoboks.',
    ...
    options: ['Muntlig advarsel', 'Forenklet forelegg (bot) uten prikker', 'Forenklet forelegg (bot) og 2 prikker', 'Beslag av førerkort på stedet'],
    correct: 1,
    explanation: '15 km/t over fartsgrensen gir forenklet forelegg (bot ca. 5600 kr i 80-sone). Under 16 km/t over = ingen prikker. Fra 16 km/t over begynner prikkbelastningen. (Ref: Forskrift om prikkbelastning 2016)' },
  {     scenario: '💥 Flere skadde ved en ulykke. Noen roper, andre er stille.',
  ...
  {     scenario: '👁️ Du har nettopp vært hos øyelegen og fått pupillene utvidet.',
  ...
  {     scenario: '🛣️ Du ser hvite kantlinjer langs begge sider av vegen.',
  ...
  {     scenario: '❄️ Du kjører med piggdekk i Oslo sentrum.',
  ...
  {     scenario: '🚗 Du lurer på hva den viktigste lovregelen i trafikken er.',
  ...
  {     scenario: '🔧 Bilen er inne til EU-kontroll. Du lurer på hva de sjekker.',
  ...
  {     scenario: '🚗 Du bruker hornet for å vise irritasjon over en saktekjørende bil.',
  ...
  {     scenario: '🚗 Tre biler møtes i uskiltert kryss fra tre retninger.',
    diagram: 'crossroads_four_way',
  ...
  {     scenario: '🚛 Du kjører med tilhenger med bremser på 80-veg.',
  ...
  {     scenario: '🔥 En person har brannsår på hånden.',
  ...
  {     scenario: '🅿️ Du parkerer utenfor en allerede parkert bil i gaten.',
  ...
  {     scenario: '♿ Du ser blå oppmerking i et parkeringshus.',
  ...
  {     scenario: '🚗 Du skal bytte felt på motorvegen.',
  ...
  {     scenario: '🚌 En buss signaliserer at den vil kjøre ut fra holdeplass.',
  ...
  {     scenario: '🚗 Du øker farten fra 50 til 100 km/t.',
    diagram: 'stopping_distance',
  ...
  {     scenario: '💥 Airbagen utløses under en kollisjon. Du hadde setebeltet på.',
  ...
  {     scenario: '😴 Du er svært trøtt bak rattet. Det er 20 mil igjen.',
  ...
  {     scenario: '🚗 Du vil kjøre i kollektivfeltet for å unngå kø.',
  ...
  {     scenario: '🔄 Du nærmer deg en rundkjøring.',
    diagram: 'roundabout_enter',
    signs: ["s16"],
  ...
  {     scenario: '🚗 Du kjører i høy fart og merker at synsfeltet snevres inn.',
  ...
  {     scenario: '🅿️ Du parkerer i en tidsbegrenset sone uten automat.',
  ...
  {     scenario: '🚗 Du vil bytte felt på motorvegen.',
    diagram: 'motorway_lane_change',
  ...
  {     scenario: '🚗 Du kjører 140 km/t i 110-sone og ser en politibil.',
  ...
  {     scenario: '❄️ November nærmer seg og du forbereder bilen for vinter.',
  ...
  {     scenario: '📊 Du leser ulykkesstatistikk og lurer på den vanligste årsaken.',
  ...
  {     scenario: '🚨 En person har hjertestans. Du er alene med pasienten.',
  ...
  {     scenario: '🛣️ Du ser grønt felt malt på vegbanen.',
  ...
  {     scenario: '🚗 En bil foran deg kjører svært sakte uten åpenbar grunn.',
  ...
  {     scenario: '🚇 Du har motorstopp inne i en tunnel.',
  ...
  {     scenario: '🚗 Rød temperaturlampe lyser under kjøring.',
    diagram: 'dashboard_warnings',
  ...
  {     scenario: '🚦 Du nærmer deg et lyskryss der lyset blinker gult.',
  ...
  {     scenario: '🏘️ Du kjører inn i et gatetun.',
    id: 294, category: 'fart', difficulty: 'middels',
    question: 'Hva er fartsgrensen i et gatetun (skilt 540)?',
  ...
  {     scenario: '🌙 Du kjører i mørket med fjernlys. En bil nærmer seg motkommende.',
  ...
  {     scenario: '🚗 Du vil bruke bussfelt for å svinge til høyre i neste gate.',
  ...
  {     scenario: '🔧 Du sjekker dekktrykket før en langtur.',
  ...
  {     scenario: '🚲 Du ser et sykkelsymbol malt i ditt kjørefelt.',
  ...
  {     scenario: '🍺 Du skal kjøre til jobb og drakk to glass vin kvelden før.',
  ...
  {     scenario: '🚗 Du ser et rundt rødt skilt med to biler side om side.',
    signs: ["s11"],
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        list: [
          'Nær kryss: parkering forbudt innenfor 10 meter fra krysset (Trafikkreglene § 17)',
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        icon: '🔄',
        text: 'Norge krever vinterdekk fra 1. november til 15. april (eller når vinterkjøreforhold foreligger). Piggdekk: Tillatt 1. november – første mandag etter 2. påskedag. Forbud mot piggdekk i deler av Oslo by (sjekk lokale regler). Mønsterdybde: Minimum 1,6 mm (sommer), 3 mm anbefalt (vinter). Kontroller dekktrykket jevnlig.',
      },
      {
    ...
    sections: [
      {
        ...
        list: [
          ...
          'Piggdekk: Lovlig 1. november – første mandag etter 2. påskedag. Gebyrbelagt i noen byer.',
  ...
  },
  {
    ...
    sections: [
      ...
      { icon: '🚫', title: 'Forbikjøring er forbudt ved...',
        list: ['Heltrukken (sammenhengende) midtlinje', 'Forbudsskilt "Forbikjøring forbudt" (skilt 334)', 'I og nær vegkryss og jernbanekryss', 'I tunnel (med noen unntak)', 'Ved gangfelt og rasfarlige strekninger', 'Når sikten er for dårlig (tåke, regn, kupering)', 'Når farten ville overstige fartsgrensen'] },
  ...
  },
  {
    ...
    sections: [
      { icon: '🛞', title: 'Dekk og hjul',
        list: ['Mønsterdybde: MINIMUM 1,6 mm (EU-krav), anbefalt 3 mm+', 'Vinterdekk: anbefalt 1. nov – 1. april (påbudt ved vinterføre)', 'Lufttrykk: sjekk månedlig – feil trykk øker bremselengde', 'Piggdekk: tillatt 1. nov – første mandag etter 2. påskedag'] },
...
const SIGNS = [
  ...
  { id: 's1',  category: 'advarsel', shape: 'triangle', symbol: '+',  name: 'Vegkryss',              number: '124', description: 'Varsler om vegkryss foran. Øk aktsomheten og reduser farten. Høyreregelen kan gjelde.' },
  ...
  { id: 's4',  category: 'advarsel', shape: 'triangle', symbol: '🚴', name: 'Syklende',             number: '144', description: 'Syklister kan ferdes langs eller krysse vegen. Vis ekstra aktsomhet og gi god siderom ved forbikjøring.' },
  ...
  { id: 's7',  category: 'advarsel', shape: 'triangle', symbol: '🦌', name: 'Vilt (elg/hjort)',       number: '146.1', description: 'Fare for dyr på vegen. Spesielt aktivt i skumring/gry og natt. Reduser farten kraftig.' },
  ...
  { id: 's23', category: 'advarsel', shape: 'triangle', symbol: '≈',  name: 'Steinsprut',            number: '112', description: 'Fare for løs grus eller steinsprut. Reduser farten og hold avstand til forankjørende. Fare for knust frontrute.' },
  ...
  { id: 's25', category: 'advarsel', shape: 'triangle', symbol: '🐴', name: 'Ridende',               number: '148', description: 'Ridende (hester) kan ferdes langs eller krysse vegen. Vis ekstra forsiktighet – hester kan bli skremt av trafikk.' },
  { id: 's34', category: 'advarsel', shape: 'triangle', symbol: '⤡',  name: 'Bratt bakke',           number: '102.1', description: 'Bratt stigning eller fall. Reduser fart i nedoverbakker, bruk lavt gir. Bremselengden øker.' },
  ...
  { id: 's36', category: 'advarsel', shape: 'triangle', symbol: '⚠',  name: 'Glatt kjørebane',       number: '116', description: 'Fare for glatt veg. Reduser farten kraftig, øk følgeavstand. Spesielt farlig i kurver og på broer.' },
  ...
  { id: 's40', category: 'advarsel', shape: 'triangle', symbol: '╪',  name: 'Planovergang uten bom', number: '135', description: 'Planovergang uten bom. Se og lytt etter tog i begge retninger. Stans ved rødt lyssignal.' },
  { id: 's41', category: 'advarsel', shape: 'triangle', symbol: '🐄', name: 'Husdyr',                number: '146.4', description: 'Fare for storfe på vegen. Vanlig i jordbruksområder. Kjør forsiktig og vær klar til å stoppe.' },
  { id: 's42', category: 'advarsel', shape: 'triangle', symbol: '🐑', name: 'Sau/rein',              number: '146.5', description: 'Fare for sau på vegen. Vanlig i fjellområder og beiteområder. Sau kan dukke opp brått.' },
  { id: 's43', category: 'advarsel', shape: 'triangle', symbol: '!',   name: 'Annen fare',            number: '156', description: 'Generelt fareskilt – annen fare som ikke har eget skilt. Underskilt angir faretypen. Øk oppmerksomheten.' },
  ...
  { id: 's11', category: 'forbud', shape: 'circle', color: '#e74c3c', symbol: '≫',  name: 'Forbikjøring forbudt',   number: '334', description: 'Forbikjøring forbudt. Gjelder til neste kryss eller opphevingsskilt. Svært alvorlig brudd.' },
  ...
  { id: 's13', category: 'forbud', shape: 'circle', color: '#e74c3c', symbol: '||',  name: 'Stans forbudt',          number: '370', description: 'Absolutt stans og parkering forbudt. Ikke stopp her under NOEN omstendigheter.' },
  { id: 's26', category: 'forbud', shape: 'circle', color: '#e74c3c', symbol: 'MC',  name: 'Moped forbudt',          number: '306.7', description: 'Motorsykler og mopeder er forbudt å kjøre her. Gjelder kun motorsykkelkjøretøy.' },
  { id: 's27', category: 'forbud', shape: 'circle', color: '#e74c3c', symbol: '10t', name: 'Forbudt for lastebil',   number: '306.3', description: 'Kjøretøy over angitt vekt er forbudt. Sjekk underskilt for nøyaktig vektgrense.' },
  ...
  { id: 's44', category: 'forbud', shape: 'circle', color: '#e74c3c', symbol: '🚗',  name: 'Motorvogn forbudt',      number: '306.1', description: 'Motorkjøretøy forbudt. Gjelder biler, motorsykler og mopeder – men ikke traktorer eller sykler.' },
  { id: 's45', category: 'forbud', shape: 'circle', color: '#e74c3c', symbol: '↰',   name: 'Venstresving forbudt',   number: '330.1', description: 'Svinging til venstre forbudt. Du kan ikke svinge til venstre ved neste kryss.' },
  { id: 's46', category: 'forbud', shape: 'circle', color: '#e74c3c', symbol: '↱',   name: 'Høyresving forbudt',     number: '330.2', description: 'Svinging til høyre forbudt. Du kan ikke svinge til høyre ved neste kryss.' },
  { id: 's47', category: 'forbud', shape: 'circle', color: '#e74c3c', symbol: '⤺',   name: 'U-sving forbudt',        number: '330.3', description: 'U-sving forbudt. Du kan ikke snu kjøretøyet her.' },
  { id: 's48', category: 'forbud', shape: 'circle', color: '#e74c3c', symbol: '🚳',  name: 'Sykling forbudt',        number: '306.6', description: 'Sykling forbudt. Syklister er ikke tillatt å kjøre her.' },
  { id: 's49', category: 'forbud', shape: 'circle', color: '#e74c3c', symbol: '🚜',  name: 'Traktor forbudt',        number: '306.5', description: 'Traktor og anleggsmaskiner forbudt. Gjelder langsomt gående kjøretøy.' },
  { id: 's50', category: 'forbud', shape: 'circle', color: '#e74c3c', symbol: '50',   name: 'Fartsgrense 50',         number: '362', description: 'Fartsgrense 50 km/t. Standard fartsgrense i tettbygd strøk. Alle fartsgrenseskilt er skilt 362.' },
  { id: 's51', category: 'forbud', shape: 'circle', color: '#e74c3c', symbol: '60',   name: 'Fartsgrense 60',         number: '362', description: 'Fartsgrense 60 km/t. Vanlig på hovedveier gjennom eller nær tettbygde strøk.' },
  { id: 's52', category: 'forbud', shape: 'circle', color: '#e74c3c', symbol: '70',   name: 'Fartsgrense 70',         number: '362', description: 'Fartsgrense 70 km/t. Vanlig på tofeltsveger utenfor tettbygd strøk.' },
  { id: 's53', category: 'forbud', shape: 'circle', color: '#e74c3c', symbol: '80',   name: 'Fartsgrense 80',         number: '362', description: 'Fartsgrense 80 km/t. Standard fartsgrense utenfor tettbygd strøk.' },
  { id: 's54', category: 'forbud', shape: 'circle-gray-strike', symbol: '50', name: 'Slutt fartsgrense',    number: '364', description: 'Slutt på fartsgrense 50 km/t. Ny fartsgrense gjelder (som regel generell fartsgrense for vegtypen).' },
  ...
  { id: 's55', category: 'påbud', shape: 'circle-blue', symbol: '↖',  name: 'Påbudt kjøreretning venstre', number: '402.4', description: 'Du MÅ svinge til venstre. Påbudsskilt – ingen valgfrihet.' },
  { id: 's56', category: 'påbud', shape: 'circle-blue', symbol: '⇨',  name: 'Påbudt kjørefelt',    number: '404.1', description: 'Påbudt kjøreretning forbi hinder. Du MÅ passere på angitt side.' },
  ...
  { id: 's19', category: 'prioritet', shape: 'octagon',      symbol: 'STOPP',   name: 'STOPP',                number: '204', description: 'Du MÅ stoppe fullstendig ved stopplinja. Gi vikeplikt for ALL trafikk – selv om vegen er tom.' },
  { id: 's20', category: 'prioritet', shape: 'diamond',                          name: 'Forkjørsveg',          number: '206', description: 'Forkjørsveg. Du har forkjørsrett over kryssende trafikk med vikepliktskilt.' },
  ...
  { id: 's33', category: 'opplysning', shape: 'rect-gray',                        name: 'Slutt motorveg',       number: '504', description: 'Motorvegen slutter. Vanlige trafikkregler gjelder igjen.' },
  { id: 's58', category: 'opplysning', shape: 'rect-blue-service', symbol: 'MT',  name: 'Motortrafikkveg',      number: '503', description: 'Motortrafikkveg. Samme regler som motorveg, men lavere standard. Minst 40 km/t, ingen gående/syklende.' },
  { id: 's59', category: 'opplysning', shape: 'rect-gray', symbol: '—',           name: 'Slutt motortrafikkveg',number: '505', description: 'Motortrafikkvegen slutter. Vanlige trafikkregler gjelder igjen.' },
  { id: 's60', category: 'opplysning', shape: 'rect-blue-service', symbol: '→',   name: 'Envegskjøring',        number: '526.1', description: 'Vegen er envegskjørt. All trafikk går i pilens retning. Ingen motgående trafikk.' },
  { id: 's61', category: 'opplysning', shape: 'rect-white-blue', symbol: '⊣',    name: 'Blindveg',             number: '527.1', description: 'Blindveg – vegen ender uten gjennomkjøring. Vurder å snu før du kjører inn.' },
  ...
  { id: 's66', category: 'opplysning', shape: 'rect-white-blue', symbol: '🏘',   name: 'Gatetun',              number: '540', description: 'Gatetun. Gangfart (maks ~6 km/t). Gående har prioritet over hele vegbanen. Parkering kun på oppmerkede plasser.' },

  // ---- SERVICESKILT (service – blue rectangle with white icon panel) ----
  { id: 's67', category: 'service', shape: 'rect-blue-service', symbol: '🏥',  name: 'Nødtelefon',    number: '605', description: 'Nødtelefon tilgjengelig i nærheten. Brukes i tunneler og langs motorveger for å ringe nødetatene.' },
  { id: 's68', category: 'service', shape: 'rect-blue-service', symbol: '🩹',  name: 'Førstehjelp',   number: '602', description: 'Førstehjelp tilgjengelig i nærheten. Nyttig å vite ved nødsituasjoner.' },
  ...
  { id: 's71', category: 'service', shape: 'rect-blue-service', symbol: '🛏',  name: 'Overnatting',    number: '614', description: 'Overnatting tilgjengelig i nærheten. Hotell, motell eller gjestehus.' },
  { id: 's72', category: 'service', shape: 'rect-blue-service', symbol: '⛺',  name: 'Camping',        number: '616', description: 'Campingplass i nærheten. For telt, bobil og campingvogn.' },
  { id: 's73', category: 'service', shape: 'rect-blue-service', symbol: '🌲',  name: 'Rasteplass',     number: '618', description: 'Rasteplass foran. Ta en pause, strekk på deg. Viktig å holde seg uthvilt bak rattet.' },
];
